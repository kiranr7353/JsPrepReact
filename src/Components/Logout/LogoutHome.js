  ...
  return (
    <div className={`row ${LogoutStyles.logoutMain}`}>
      <div className="col-lg-12 col-md-12 col-sm-12">
        ...
        <div>
          <Link to="/login"><CommonButton variant="contained" bgColor={'#5b67f1'} color={'white'} padding={'15px'} borderRadius={'5px'} fontWeight={'bold'} width={'20%'} height={'45px'} marign={'20px 0 0 0'}>Login Again</CommonButton></Link>
        </div>
      </div>
    </div>
  )
