...
import { Alert, Button, Dialog, DialogContent, Drawer, FormControl, FormControlLabel, Slide, Snackbar, Stack, TextField, Typography } from '@mui/material';
...
const EditDescription = ({ desc, editClicked, setEditClicked, sectionId, locationDetails, categoryId, contentData, GetHooks, setSelectedIndex, setContentData }) => {
                ...
                {description?.map((el, i) => (
                  <div>
                    ...
                    <div className={ReactStyles.editBtnContainer}>
                      <div>
                        <CommonButton variant="contained" bgColor={'#5b67f1'} color={'white'} padding={'15px'} borderRadius={'5px'} fontWeight={'bold'} width={'100%'} height={'45px'} marign={'20px 0 0 0'} onClick={() => handleEditSave(description)}>Save</CommonButton>
                      </div>
                      <div>
